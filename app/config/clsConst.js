...
const PRO_APP_VERSION = "PR1.2.39";
const LITE_APP_VERSION = "LT1.2.39";
const VIEWER_APP_VERSION = "VW1.2.39";
...
const LOG_URL = "https://2cde-2001-e68-69aa-a000-301d-21af-ad7a-39b1.ngrok-free.app";
...
const TEST_REVIEW = `AppReview_${Platform.OS}_1.2.39`;
